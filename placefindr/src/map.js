...
function MapInit() {
  return (
    <MapContainer center={[39.828, -98.579]} zoom={4} id="map">
      <TileLayer
...
// let map = L.map('map').setView([39.828, -98.579], 4);
...
let originalData = [];
let bestPoints =[];
let bestLayerGroup = L.layerGroup()
...
function findBestPoints(points)
{
  ...
  let bestPointsAr = [bestPoints[0], bestPoints[1], bestPoints[2], bestPoints[3], bestPoints[4]]
...
export default MapInit;//, updateHeatmap};
